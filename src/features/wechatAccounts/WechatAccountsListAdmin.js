...
import {selectAllWechatAccounts, useGetAllWechatAccountsQuery} from './wechatAccountsSlice';
...
const WechatAccountsListAdmin = () => {
    ...
    const orderedWechatAccounts = useSelector(selectAllWechatAccounts);
...
export default WechatAccountsListAdmin;