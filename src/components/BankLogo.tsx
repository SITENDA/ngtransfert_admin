...
const BankLogo: React.FC<BankLogoProps> = ({ logoUrl, alt, style }) => {
    if (!logoUrl) {
        ...
        return <div style={{ width: 50, height: 50, marginRight: '5px', display: 'inline-block', backgroundColor: '#ccc', ...style }}></div>;
    }
    ...
    return (
        <Image
            ...
            alt={alt}
            width={boundingWidth} // Required numerical width
            height={desiredHeight} // Required numerical height
            style={{
                marginRight: '5px',
                objectFit: 'contain', // Key to maintaining aspect ratio
